...
<head>
    ...
    <meta name="author" content="Vaja Sinauridze <vajasin@gmail.com>">
    ...
    <script src="{{ asset('assets/libs/js/jquery-3.5.1.min.js') }}"></script>
                ...
                <form action="{{cms_route('login')}}" method="POST" role="form" id="login" class="login-form fade-in-effect">
                    ...
                    <div class="login-header">
                        <div style="margin-bottom: 20px">
                            <img src="{{asset('/assets/images/logo-l.svg')}}" alt="" style="width: 48px" align="left">
                            <h1>Stella <span style="font-size: 12px; color: gray">v{{explode(' ', config('cms.version'))[0]}}</span></h1>
                        </div>
                    </div>
                    <div class="login-header">
